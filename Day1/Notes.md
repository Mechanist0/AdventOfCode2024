...
Instead, the Elves discover an assortment of notes and lists of historically significant locations! This seems to be the planning the Chief Historian was doing before he left. Perhaps these notes can be used to determine which locations to search?
...
# Notes
## Part 1
1. Pair up by smallest to largest
2. Measure distance between
3. Add up distances

Read lists from file into a vector


Sort list numerically (Want to try functionally)
Absolute value Subtract
Zip the two lists using functional???

## Part 2
How often each number in left appears in right
Score by
 - Multiply left number by times appeared in right
 - accumulate
